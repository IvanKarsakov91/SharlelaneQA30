...
public class ShoppingCartTest {
    ...
    public void checkDiscount0() {
        ...
        driver.get("https://www.sharelane.com/cgi-bin/register.py?page=2&zip_code=12345&first_name=Ivan&" +
                "last_name=Karsakov&email=Iva%40mail.ru&password1=123qw&password2=123qw");
        ...
        driver.findElement(By.name("password")).sendKeys("123qw");
